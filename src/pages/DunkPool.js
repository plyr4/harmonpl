...
import Pam from '../img/pam/pam_dunk.jpg';
import './Pages.css';
const clue = (<Clue
...
function DunkPool() {
    return (
        <div className="DunkPool">
            ...
            <p> What I've learned, Pam is living her best life. I can't imagine her drinking water any other way.
                </p>
                <p>
                <img alt="pool2" width="480" src={Pam} />
            </p>
            {clue}
        </div>
    );
